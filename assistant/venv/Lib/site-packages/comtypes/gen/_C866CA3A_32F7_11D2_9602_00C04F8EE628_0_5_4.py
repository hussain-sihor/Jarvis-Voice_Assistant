...
__all__ = [
    ...
    'ISpRecoContext', 'DISPID_SVPriority',
    'SpeechGrammarRuleStateTransitionType', 'SPGS_ENABLED',
    'SpeechAudioFormatGUIDText', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechWaveFormatEx', 'SVP_9', 'ISpeechRecognizer',
    'SAFT11kHz16BitMono', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRRGetXMLResult', 'SREAudioLevel', 'DISPID_SLWType',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'eLEXTYPE_RESERVED6',
    'SPEI_END_SR_STREAM', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SASState', 'SRAInterpreter', 'DISPID_SPPId', 'ISpAudio',
    'DISPID_SPRs_NewEnum', 'SREPrivate',
    'DISPID_SASCurrentDevicePosition', 'SP_VISEME_1', 'SVP_3',
    'SDTDisplayText', 'DISPID_SpeechGrammarRules',
    'DISPID_SMSALineId', 'IStream', 'SAFT24kHz8BitStereo',
    'SAFTADPCM_8kHzStereo', 'IEnumString',
    'Speech_StreamPos_RealTime', 'SPEI_MAX_TTS',
    'DISPID_SPRuleConfidence', 'DISPID_SOTIsUISupported',
    'DISPID_SLAddPronunciation', 'eWORDTYPE_DELETED',
    'ISpeechWaveFormatEx', 'ISpeechLexiconWord', 'SVP_11',
    'DISPID_SGRInitialState', 'DISPID_SVSVisemeId', 'SPWT_LEXICAL',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SDKOpenKey',
    'SAFT8kHz8BitStereo', 'SPVOICESTATUS', 'SPAS_PAUSE',
    'SAFT44kHz8BitMono', 'IInternetSecurityManager', 'ISpeechDataKey',
    'SpeechVoicePriority', 'SpeechTokenContext',
    ...
    'DISPID_SGRsCommit', 'DISPID_SpeechGrammarRule',
    'ISpeechGrammarRules', 'SP_VISEME_15',
    'DISPID_SPEActualConfidence', 'DISPID_SPIAudioSizeBytes',
    'SAFT8kHz16BitMono', 'SPSNotOverriden', 'DISPID_SGRSTNextState',
    'SPEI_HYPOTHESIS', 'SpeechRecoContextState', 'SVP_0',
    'DISPID_SPELexicalForm', 'DISPID_SRCERecognizerStateChange',
    'SSTTDictation', 'SAFT44kHz16BitMono', 'SPRST_INACTIVE',
    'DISPID_SPRuleId', 'SPRS_ACTIVE', 'DISPID_SPPConfidence',
    'SPBOOKMARKOPTIONS', 'SpVoice', 'LONG_PTR', 'SRERecoOtherContext',
    'DISPID_SRCState', 'SAFT16kHz16BitMono',
    'DISPID_SRCEFalseRecognition', 'SPDKL_LocalMachine',
    'DISPID_SRCEventInterests', 'DISPID_SPIStartTime',
    'SECFIgnoreKanaType', 'SPVISEMES', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SpeechLexiconWord', 'SDKLDefaultLocation',
    'SPRECOGNIZERSTATUS', 'SPPARTOFSPEECH', 'SAFT44kHz8BitStereo',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPIEngineId',
    'SpeechEmulationCompareFlags', 'SAFT48kHz16BitStereo',
    'DISPID_SPIAudioStreamPosition', 'SAFTGSM610_44kHzMono',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRCESoundStart',
    'DISPID_SRCEEnginePrivate', 'SVP_1', 'SPAR_Unknown',
    'SPGRAMMARWORDTYPE', 'SRSActiveAlways',
    'DISPID_SOTGetDescription', 'SpeechDictationTopicSpelling',
    'DISPID_SPAPhraseInfo', 'eWORDTYPE_ADDED',
    'SpeechEngineProperties', 'SGDisplay', 'DISPID_SOTGetAttribute',
    'ISpeechRecoResult', 'DISPID_SLPs_NewEnum', 'SP_VISEME_2',
    'DISPID_SRGIsPronounceable', 'SPEVENT', 'SGDSInactive',
    'DISPID_SpeechMemoryStream', 'DISPID_SGRAttributes',
    'DISPID_SOTDisplayUI', 'SPPS_RESERVED3', 'SVF_Stressed',
    'SAFTCCITT_ALaw_22kHzMono', 'SPVPRI_ALERT', 'SITooQuiet',
    'DISPID_SRProfile', 'SSSPTRelativeToCurrentPosition',
    'SpeechCategoryRecoProfiles', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPRDisplayAttributes', 'eLEXTYPE_USER_SHORTCUT',
    ...
    'SPPS_LMA', 'SPRST_INACTIVE_WITH_PURGE', 'ISpNotifySink',
    'DISPID_SRGDictationUnload', 'DISPID_SPEAudioStreamOffset',
    'SVSFParseMask', 'DISPID_SGRSTRule', 'SPCS_ENABLED',
    'DISPID_SOTGetStorageFileName', 'DISPID_SLRemovePronunciation',
    'SSFMCreateForWrite', 'SpeechRegistryUserRoot',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SGRAddResource', 'SVP_13',
    'DISPID_SRCERecognitionForOtherContext', 'SPSHT_EMAIL',
    'DISPID_SLWsCount', 'DISPID_SRRTimes', 'SpeechFormatType',
    'ISpeechGrammarRule', 'DISPID_SVEPhoneme', 'DISPID_SPAsItem',
    'SPEI_PHONEME', 'DISPID_SPIElements', 'ISpStreamFormatConverter',
    'SPEI_RESERVED3', 'DISPID_SAVolume', 'DISPID_SRAudioInput',
    'SVSFPurgeBeforeSpeak', '_SPAUDIOSTATE', 'ISequentialStream',
    'DISPID_SVEStreamEnd', 'DISPID_SDKSetBinaryValue',
    'DISPID_SPARecoResult', 'DISPID_SASFreeBufferSpace',
    'ISpeechPhraseInfoBuilder', 'SpMemoryStream',
    'DISPID_SABufferInfo', 'SPLO_DYNAMIC', 'ISpeechMemoryStream',
    'DISPID_SRCCreateGrammar', 'SpeechRunState', 'SpeechAllElements',
    'eLEXTYPE_RESERVED9', 'DISPID_SOTCId', 'DISPID_SpeechVoice',
    'SpeechEngineConfidence', 'DISPID_SPAStartElementInResult',
    'DISPID_SPCLangId', 'SpeechRegistryLocalMachineRoot',
    'eLEXTYPE_PRIVATE19', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SVWaitUntilDone', 'DISPID_SpeechGrammarRuleState',
    'ISpeechRecoResultTimes', 'SPLO_STATIC', 'eLEXTYPE_PRIVATE1',
    'SPPHRASEELEMENT', 'SVEWordBoundary', 'SVF_Emphasis',
    'DISPID_SPAs_NewEnum', 'DISPID_SASNonBlockingIO', 'SP_VISEME_8',
    'SPAO_NONE', 'SAFTCCITT_uLaw_11kHzStereo', 'ISpRecoGrammar',
    'DISPID_SRRTTickCount', 'SPEI_MIN_SR', 'DISPID_SVResume',
    'SpFileStream', 'DISPID_SOTCSetId', 'DISPID_SPEDisplayAttributes',
    ...
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SPRulesCount', 'DISPID_SRSetPropertyString', 'STCAll',
    'DISPID_SPPParent', 'ISpPhoneticAlphabetSelection',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT48kHz8BitStereo',
    'SpeechAudioProperties', 'ISpDataKey', 'IInternetSecurityMgrSite',
    'SAFTGSM610_8kHzMono', 'eLEXTYPE_PRIVATE13', 'SPPS_Noncontent',
    'SWPKnownWordPronounceable', 'SAFT16kHz8BitMono',
    'DISPID_SVEStreamStart', 'DISPID_SRCEStartStream',
    'SVESentenceBoundary', 'SVP_16', 'SAFTCCITT_ALaw_8kHzMono',
    'SVP_8', 'SPSLMA', 'DISPID_SRRPhraseInfo', 'SPEI_RESERVED1',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVSCurrentStreamNumber',
    'SRAImport', 'SDA_No_Trailing_Space', 'SPWORDTYPE',
    'SSTTWildcard', 'SPRST_ACTIVE_ALWAYS', 'SREStreamEnd',
    'ISpeechLexiconWords', 'SPCT_DICTATION', 'eLEXTYPE_PRIVATE16',
    'SPAS_CLOSED', 'SPAUDIOOPTIONS', 'SpStreamFormatConverter',
    'ISpeechPhraseElements', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCreateRecoContext', 'DISPID_SRAudioInputStream',
    'SGSExclusive', 'ISpeechVoiceStatus', 'eLEXTYPE_RESERVED4',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SRRRecoContext',
    'ISpeechLexiconPronunciation', 'SPWORDLIST',
    'DISPID_SRGetPropertyNumber', 'SPRST_ACTIVE', 'SPEI_INTERFERENCE',
    'SPINTERFERENCE_NOISE', '__MIDL_IWinTypes_0009',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SLGetGenerationChange', 'SpMMAudioIn', 'SGDSActive',
    'DISPID_SPPValue', 'DISPID_SOTMatchesAttributes',
    'SpeechRecoProfileProperties', 'DISPID_SRGCmdLoadFromResource',
    'SRSInactiveWithPurge', 'SPSSuppressWord', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SMSGetData', 'SDTReplacement', 'SRTExtendableParse',
    'SVSFParseSsml', 'SDKLCurrentConfig', 'SVEAllEvents',
    'ISpeechPhraseProperties', 'ISpGrammarBuilder',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechPhraseRule',
    'SPPS_RESERVED4', 'DISPID_SpeechPhraseElement', 'SVSFDefault',
    'SWPUnknownWordPronounceable', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPEI_TTS_PRIVATE', 'DISPID_SpeechVoiceStatus', 'SPAS_STOP',
    'SpeechCategoryAudioIn', 'SpeechWordPronounceable', 'SPFILEMODE',
    'SpeechTokenValueCLSID', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPPEngineConfidence', 'DISPID_SPRulesItem',
    'DISPIDSPTSI_SelectionOffset', 'SVEAudioLevel', 'SPEI_RESERVED5',
    'SPBO_NONE', 'DISPID_SVSInputSentencePosition',
    'eLEXTYPE_PRIVATE15', 'SP_VISEME_11', 'DISPID_SRCPause',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SVSFIsFilename',
    'eLEXTYPE_PRIVATE6', 'SBOPause', 'SECNormalConfidence',
    'SAFTNonStandardFormat', 'SGLexical', 'DISPID_SRGId', 'SVSFIsXML',
    'DISPID_SDKDeleteKey', 'SREAdaptation', 'DISPID_SVGetVoices',
    'SPPROPERTYINFO', 'DISPID_SOTCategory',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SLPLangId',
    'DISPID_SRGetFormat', 'SBONone', 'SpPhoneConverter',
    'SPINTERFERENCE_TOOFAST', 'SVEBookmark', 'SpeechAudioFormatType',
    'SITooLoud', 'SVEPhoneme', 'DISPID_SRCVoice', 'SRTReSent',
    'SVPAlert', 'ISpeechAudio', 'SP_VISEME_16', 'SpeechAudioVolume',
    'SpeechTokenKeyAttributes', 'SECFIgnoreCase',
    'SpeechBookmarkOptions', 'SPEVENTSOURCEINFO', 'SPWF_INPUT',
    'SVP_20', 'DISPID_SRCEInterference', 'DISPID_SPPFirstElement',
    'DISPID_SGRSTText', 'SFTSREngine', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SGRSTsCount', 'SRARoot', 'SPBO_TIME_UNITS',
    'SP_VISEME_20', 'DISPID_SWFEBlockAlign', 'STCInprocHandler',
    'SPEI_RECOGNITION', 'SAFT44kHz16BitStereo', 'DISPID_SASetState',
    'SPCONTEXTSTATE', 'SGLexicalNoSpecialChars', 'SPEI_SR_PRIVATE',
    'DISPID_SRRSaveToMemory', 'SpeechGrammarTagUnlimitedDictation',
    'eLEXTYPE_PRIVATE8', 'SpeechPropertyLowConfidenceThreshold',
    'SPEI_FALSE_RECOGNITION', 'STSF_AppData', 'SpeechRecognitionType',
    'ISpeechXMLRecoResult', 'DISPID_SLPSymbolic',
    'DISPID_SpeechPhraseProperties', 'SVP_15', 'ISpRecoResult',
    'SDA_One_Trailing_Space', 'DISPID_SRSClsidEngine', 'SRCS_Enabled',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFTCCITT_uLaw_22kHzMono',
    'SINoise', 'eLEXTYPE_PRIVATE17', 'SpInprocRecognizer',
    'eLEXTYPE_PRIVATE2', 'SpeechVoiceSpeakFlags',
    'SAFT16kHz8BitStereo', 'DISPID_SVSpeak', 'SPPS_Verb',
    'SpeechVoiceCategoryTTSRate', 'SECFIgnoreWidth',
    'Speech_Max_Pron_Length', 'SPSHORTCUTPAIR', 'SRATopLevel',
    'DISPID_SVSkip', 'SDTAlternates', 'SECHighConfidence',
    'DISPIDSPTSI_SelectionLength', 'SDTRule', 'DISPID_SFSOpen',
    'ISpeechAudioFormat', 'DISPID_SAFType', 'DISPID_SGRClear',
    'DISPID_SDKSetLongValue', 'SRSActive', 'eLEXTYPE_PRIVATE14',
    'SPLEXICONTYPE', 'SAFTADPCM_22kHzMono', 'DISPID_SVAudioOutput',
    'SpeechRecoEvents', 'ISpProperties', 'DISPID_SPRText',
    'DISPID_SOTRemove', 'DISPID_SLGetWords', 'DISPIDSPTSI',
    'Speech_StreamPos_Asap', 'DISPID_SWFEAvgBytesPerSec',
    'SPAUDIOSTATUS', 'SPPS_NotOverriden', 'SLTUser', 'SpAudioFormat',
    'SPRULE', 'SPVPRI_NORMAL', 'SAFTExtendedAudioFormat',
    'DISPID_SpeechRecoContextEvents',
    'DISPID_SVSLastStreamNumberQueued', 'SAFT12kHz8BitMono',
    'DISPID_SGRSTType', 'SPEI_END_INPUT_STREAM',
    'DISPID_SGRSTPropertyName', 'eLEXTYPE_MORPHOLOGY', 'SRAExport',
    'SpeechCategoryVoices', 'DISPID_SpeechPhraseRule',
    'ISpeechBaseStream', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPEI_MIN_TTS', 'ISpRecognizer', 'ISpLexicon',
    'SpeechTokenKeyFiles', 'DISPID_SpeechGrammarRuleStateTransition',
    'SVSFPersistXML', 'DISPID_SGRSTransitions',
    'DISPID_SRSNumberOfActiveRules', 'SAFT12kHz8BitStereo',
    'DISPID_SAFGetWaveFormatEx', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SLPPartOfSpeech', 'SPVPRIORITY', 'SAFT24kHz8BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SOTId',
    'SPWAVEFORMATTYPE', 'DISPID_SOTCGetDataKey',
    'SAFT11kHz8BitStereo', 'SPEI_PHRASE_START',
    'SpNullPhoneConverter', 'SpeechRetainedAudioOptions',
    'SVEEndInputStream', 'DISPID_SpeechRecoResult',
    'DISPID_SRCEPhraseStart',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SGSDisabled',
    'SPCS_DISABLED', 'SPPS_RESERVED2', 'DISPID_SGRsItem',
    'DISPID_SpeechPhraseInfo', 'SPAR_High', 'SREStateChange',
    'ISpPhoneConverter', 'STSF_FlagCreate',
    'DISPID_SpeechRecoResult2', 'SAFT32kHz8BitMono',
    'SpeechGrammarWordType', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPILanguageId',
    'SP_VISEME_19', 'DISPID_SGRAddState', 'IEnumSpObjectTokens',
    'SPSHT_OTHER', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRRSpeakAudio', 'DISPID_SRRecognizer',
    'SAFTGSM610_22kHzMono', 'SPCATEGORYTYPE',
    'DISPID_SpeechCustomStream', 'SSSPTRelativeToStart',
    'DISPID_SVEWord', 'SP_VISEME_4', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SDKEnumKeys', 'eLEXTYPE_RESERVED8', 'SpeechVisemeType',
    'SpeechPropertyResourceUsage', 'DISPID_SpeechRecoContext',
    'SVSFlagsAsync', 'SVP_12', 'SPSInterjection', 'SASPause',
    'SREFalseRecognition', 'DISPID_SWFEChannels', 'SVP_2',
    'SP_VISEME_18', 'SpStream', 'SPWT_DISPLAY', 'SPDKL_CurrentUser',
    'SpeechInterference', 'DISPID_SPRules_NewEnum', 'SpMMAudioEnum',
    'ISpeechAudioBufferInfo', 'STCLocalServer', 'SAFTADPCM_11kHzMono',
    'SVEViseme', 'DISPID_SRSSupportedLanguages', 'SVSFNLPSpeakPunc',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPPsCount', 'DISPID_SBSWrite',
    'DISPID_SCSBaseStream', 'SP_VISEME_10', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SVESentenceBoundary', 'SAFTADPCM_22kHzStereo',
    'SPEI_SOUND_START', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SGRId', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPSHT_NotOverriden', 'DISPID_SDKCreateKey', 'DISPID_SBSFormat',
    'ISpeechLexicon', 'DISPID_SBSSeek', 'SPEI_SOUND_END',
    'DISPID_SpeechPhraseBuilder', 'SVP_6', 'SPINTERFERENCE_NONE',
    'SpeechRecognizerState', 'SPPS_Function', 'SPEI_VISEME',
    'SRERecognition', 'SpInProcRecoContext', 'SpLexicon',
    'DISPID_SRGState', 'SpSharedRecognizer', 'SGRSTTRule',
    'SREStreamStart', 'SSFMCreate', 'DISPID_SVEVoiceChange', 'SVP_19',
    'SVP_18', 'SAFT24kHz16BitMono', 'ISpMMSysAudio',
    'ISpeechPhraseRules', 'DISPID_SGRName', 'DISPID_SPEDisplayText',
    'SpeechDataKeyLocation', 'DISPID_SPPsItem', 'tagSTATSTG',
    'DISPID_SAFSetWaveFormatEx', 'SRSInactive', 'ISpeechCustomStream',
    ...
    'SPEI_ADAPTATION', 'DISPID_SGRsCount', 'SPSERIALIZEDPHRASE',
    'SPEI_MAX_SR', 'DISPID_SVSInputSentenceLength',
    'ISpeechPhoneConverter', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SGRsDynamic', 'SAFT32kHz8BitStereo', 'SPLOADOPTIONS',
    'DISPID_SBSRead', 'SP_VISEME_17',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SGRsAdd', 'DISPID_SPERequiredConfidence',
    'DISPID_SpeechLexiconProns', 'eLEXTYPE_RESERVED7', 'SPSUnknown',
    'SpeechTokenIdUserLexicon', 'SVSFNLPMask', 'SLODynamic',
    'SPEI_UNDEFINED', 'SINoSignal', 'SPEI_START_SR_STREAM',
    'DISPID_SpeechPhraseReplacement', 'SPEI_START_INPUT_STREAM',
    'SAFT24kHz16BitStereo', 'DISPID_SRState', 'DISPID_SOTSetId',
    'DISPID_SpeechRecognizer', 'SRTAutopause', 'SRESoundEnd',
    'DISPID_SVAlertBoundary', 'DISPID_SPCPhoneToId',
    'DISPID_SpeechPhraseAlternate', 'SPSNoun', 'SECFNoSpecialChars',
    'DISPID_SPCIdToPhone', 'SpeechGrammarState',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SDKGetStringValue',
    'DISPID_SRIsShared', 'eLEXTYPE_PRIVATE18',
    'DISPID_SREmulateRecognition', 'DISPID_SRRTStreamTime',
    'DISPID_SPEEngineConfidence', 'DISPID_SPRsCount',
    'DISPID_SPIGetText', 'DISPID_SVSLastResult',
    'SPDKL_CurrentConfig', 'SRADefaultToActive',
    'ISpeechObjectTokens', 'DISPID_SRGRecoContext',
    'DISPID_SRCERequestUI', 'DISPID_SDKSetStringValue',
    'DISPID_SOTs_NewEnum', 'SPEI_RESERVED6', 'DISPID_SABIBufferSize',
    'ISpeechPhraseAlternate', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRStatus', 'DISPID_SPPChildren',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechSpecialTransitionType',
    'SpCustomStream', 'DISPID_SPEPronunciation',
    'DISPID_SpeechLexicon', 'DISPID_SGRSAddWordTransition',
    'SPFM_NUM_MODES', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpUnCompressedLexicon', 'SP_VISEME_21', 'DISPIDSPRG',
    'SPXMLRESULTOPTIONS', 'DISPID_SAStatus', 'DISPID_SRCEEndStream',
    'SPGS_DISABLED', 'SRSEIsSpeaking', 'SSFMOpenReadWrite',
    'DISPID_SPIGetDisplayAttributes', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SGRsFindRule', 'DISPID_SOTsCount', 'SPAUDIOBUFFERINFO',
    'SpCompressedLexicon', 'SPRULESTATE', 'SpeechWordType',
    'SDTLexicalForm', 'DISPID_SDKDeleteValue',
    'DISPID_SVSpeakCompleteEvent', 'SASRun', 'SPSHORTCUTPAIRLIST',
    'SITooSlow', 'DISPID_SRCRecognizer', 'SpMMAudioOut',
    'SPPS_SuppressWord', 'DISPID_SRGRules', 'SPPHRASEPROPERTY',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechDataKey',
    'DISPID_SVEAudioLevel', 'SpeechRuleAttributes',
    'ISpeechRecognizerStatus', 'ISpRecoGrammar2',
    'DISPID_SpeechAudio', 'SPWORD', 'SPPHRASEREPLACEMENT',
    'eLEXTYPE_PRIVATE7', 'DISPID_SVGetProfiles',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPRsItem',
    'DISPID_SPACommit', 'DISPID_SpeechLexiconWords', 'SP_VISEME_9',
    'SVSFParseAutodetect', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPEAudioSizeTime', 'SpeechPropertyComplexResponseSpeed',
    'SECFDefault', 'SGRSTTEpsilon', 'SAFTDefault', 'SVP_5',
    'ISpeechGrammarRuleStateTransition', 'ISpRecognizer2',
    'SPVPRI_OVER', 'SAFTADPCM_8kHzMono', 'ISpPhrase',
    'ISpeechAudioStatus', 'SpeechPropertyAdaptationOn',
    'STCInprocServer', 'ISpeechTextSelectionInformation',
    'DISPID_SPIGrammarId', 'SPEI_WORD_BOUNDARY',
    'SAFTNoAssignedFormat', 'SPSMF_UPS', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SVSInputWordLength', 'SpPhraseInfoBuilder',
    'ISpObjectToken', 'SpeechAudioFormatGUIDWave', 'ISpXMLRecoResult',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpeechAddRemoveWord',
    'DISPID_SpeechMMSysAudio', 'SREInterference', 'DISPID_SGRSTsItem',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SVAudioOutputStream', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SPEsItem', 'DISPID_SLWLangId', 'ISpeechRecoResult2',
    'SRERequestUI', 'SPWF_SRENGINE', 'DISPID_SRRAudio',
    'ISpeechObjectToken', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SVSLastBookmark', 'SAFTADPCM_11kHzStereo', 'SGRSTTWord',
    'SWTAdded', 'DISPID_SpeechAudioStatus',
    'ISpeechPhraseReplacement',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpResourceManager',
    'DISPID_SLWsItem', 'DISPID_SRRGetXMLErrorInfo', 'UINT_PTR',
    'ISpeechRecoResultDispatch', 'SVPNormal', 'ISpeechMMSysAudio',
    'DISPID_SDKGetBinaryValue', 'SPGRAMMARSTATE',
    'DISPID_SpeechPhoneConverter', 'SVP_7', 'DISPID_SVSpeakStream',
    'ISpVoice', 'ISpObjectTokenCategory', 'DISPID_SRCEHypothesis',
    'SAFTGSM610_11kHzMono', 'SVF_None', 'DISPID_SRRAudioFormat',
    ...
    'DISPID_SVVoice', 'DISPID_SLPsItem',
    'DISPID_SPIEnginePrivateData', 'DISPID_SLGetPronunciations',
    'SPCT_SUB_DICTATION', 'DISPID_SVDisplayUI',
    'DISPID_SLGenerationId', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SWFEBitsPerSample', 'DISPID_SMSADeviceId',
    'SAFT48kHz16BitMono', 'SPSHORTCUTTYPE', 'SpeechRuleState',
    'DISPID_SpeechFileStream', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRCBookmark', 'ISpeechResourceLoader', 'SRAONone',
    'SRCS_Disabled', 'SGPronounciation', 'SPAR_Low',
    'DISPID_SPAsCount', 'SASClosed', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SVSFIsNotXML', 'SPSEMANTICERRORINFO', 'DISPID_SRDisplayUI',
    'SAFT11kHz16BitStereo', 'SPDATAKEYLOCATION', 'eLEXTYPE_PRIVATE11',
    'SPSEMANTICFORMAT', 'DISPID_SRCERecognition',
    'SAFT22kHz16BitMono', 'eLEXTYPE_PRIVATE20', 'SpNotifyTranslator',
    'SVPOver', 'DISPID_SLPPhoneIds', 'SPSERIALIZEDRESULT',
    'SPXRO_SML', 'DISPID_SPIReplacements', 'SpeechDiscardType',
    'SPFM_OPEN_READONLY', 'DISPID_SPEsCount', 'ISpStream',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVSFVoiceMask',
    'WAVEFORMATEX', 'SREHypothesis', 'STSF_CommonAppData',
    'ISpeechPhraseProperty', 'SP_VISEME_0', 'SPXRO_Alternates_SML',
    'DISPID_SRCRequestedUIType', 'DISPID_SRGSetWordSequenceData',
    'SPWT_PRONUNCIATION', 'SAFT22kHz16BitStereo',
    'SAFTADPCM_44kHzMono', 'ISpRecognizer3', 'eLEXTYPE_USER',
    'DISPID_SpeechObjectTokenCategory', 'ISpRecoCategory',
    'SDTProperty', 'SAFT11kHz8BitMono', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SOTCDefault', 'SpeechTokenShellFolder',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRGDictationSetState',
    'SVSFParseSapi', 'SGRSTTWildcard', 'ISpEventSink',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPRuleName',
    'DISPID_SVSyncronousSpeakTimeout', 'SREBookmark',
    'SPFM_OPEN_READWRITE', 'ISpObjectWithToken', 'SP_VISEME_3',
    'SAFTText', 'SPBO_AHEAD', 'SPTEXTSELECTIONINFO',
    'DISPID_SRGSetTextSelection', 'DISPID_SVStatus',
    'DISPID_SpeechPhraseElements', 'DISPID_SRCEAdaptation',
    'DISPID_SLPsCount', 'ISpEventSource', 'DISPID_SVRate',
    'SPSTREAMFORMATTYPE', 'ISpeechPhraseAlternates', 'SASStop',
    'SPEI_TTS_BOOKMARK', 'SPEI_VOICE_CHANGE',
    'DISPID_SpeechAudioBufferInfo', 'SpeechLoadOption',
    'SECFEmulateResult', 'DISPID_SVEventInterests',
    '_ISpeechRecoContextEvents', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SGRSTs_NewEnum',
    'SP_VISEME_7', 'eLEXTYPE_PRIVATE10', 'ISpeechPhraseReplacements',
    'DISPID_SVSInputWordPosition', 'DISPID_SRSetPropertyNumber',
    'SAFT16kHz16BitStereo', 'SDKLLocalMachine', 'DISPID_SVEViseme',
    'SREAllEvents', 'SpeechStreamSeekPositionType', 'DISPID_SVPause',
    'DISPID_SRIsUISupported', 'SPRECOSTATE', 'eLEXTYPE_RESERVED10',
    'SVP_21', 'SP_VISEME_13', 'SPWORDPRONUNCIATION',
    'SPEI_REQUEST_UI', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRCEPropertyNumberChange', 'SpeechMicTraining',
    'SSTTTextBuffer', 'SPPHRASE', 'DISPID_SPISaveToMemory',
    'ISpNotifySource', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPRST_NUM_STATES', 'SPEI_RECO_OTHER_CONTEXT',
    'SPRECORESULTTIMES', 'SpeechVoiceSkipTypeSentence',
    'SDTPronunciation', 'DISPID_SpeechBaseStream',
    'SAFT12kHz16BitMono', 'DISPID_SVGetAudioOutputs',
    'SpResourceManager', 'SPSVerb', 'eLEXTYPE_APP', 'SPSFunction',
    'SPGS_EXCLUSIVE', 'DISPID_SRSAudioStatus', 'SPAS_RUN', 'SVP_4',
    'SITooFast', 'DISPID_SRGDictationLoad', 'SGSEnabled',
    'DISPID_SPPName', 'DISPID_SVVolume', 'SPCT_SUB_COMMAND',
    'SPPS_RESERVED1', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SDTAll', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVSLastBookmarkId', 'SAFT48kHz8BitMono',
    'DISPID_SVGetAudioInputs', 'ISpeechVoice',
    'DISPID_SGRSTPropertyValue', 'SVEStartInputStream', 'SVP_14',
    'DISPID_SRGCmdSetRuleState', 'SPFM_CREATE_ALWAYS',
    'SREPhraseStart', 'STCRemoteServer', '_RemotableHandle',
    'ISpeechPhraseElement', 'SAFT12kHz16BitStereo', 'ISpRecoContext2',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SOTsItem',
    'DISPID_SOTCreateInstance', 'SREPropertyStringChange',
    'SRAORetainAudio', 'SLTApp', 'SPWORDPRONOUNCEABLE',
    'tagSPPROPERTYINFO', 'DISPID_SLWWord', 'ISpeechPhraseInfo',
    'SpWaveFormatEx', 'ISpSerializeState', 'SPBINARYGRAMMAR',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SABIEventBias',
    'DISPID_SPIRetainedSizeBytes', 'SpeechUserTraining',
    'SECLowConfidence', 'ISpeechGrammarRuleState', 'SPSHT_Unknown',
    'SPCT_SLEEP', 'SpeechStreamFileMode', 'DISPID_SWFEFormatTag',
    'ISpeechGrammarRuleStateTransitions', 'SPAR_Medium',
    'SRTEmulated', 'DISPID_SGRSTWeight', 'SpeechTokenKeyUI',
    'SpeechGrammarTagWildcard', 'SWTDeleted',
    'DISPID_SRGetRecognizers', 'SINone', 'SpeechDisplayAttributes',
    'SPPS_Interjection', 'DISPID_SRCEAudioLevel',
    ...
    'SpeechGrammarTagDictation', 'SRTStandard', 'SPPS_Modifier',
    'DISPID_SpeechObjectTokens', 'SFTInput', 'SREPropertyNumChange',
    'SpeechAudioState', 'SPPS_Unknown', 'SDA_Consume_Leading_Spaces',
    'SAFT22kHz8BitMono', 'SPEI_SR_BOOKMARK', 'DISPID_SDKGetlongValue',
    'DISPID_SPPs_NewEnum', 'SPEI_RESERVED2', 'SRSEDone',
    'DISPID_SpeechAudioFormat', 'SAFTCCITT_uLaw_8kHzMono',
    'SpShortcut', 'DISPID_SLWs_NewEnum', 'SpeechVoiceEvents',
    'DISPID_SPRuleParent', 'DISPID_SMSSetData', 'SPINTERFERENCE',
    'DISPID_SAEventHandle', 'DISPID_SpeechLexiconPronunciation',
    'Speech_Default_Weight', 'DISPID_SVEEnginePrivate', 'SP_VISEME_6',
    'SDKLCurrentUser', 'DISPID_SpeechVoiceEvent', 'STSF_LocalAppData',
    'DISPID_SRCRetainedAudio', 'DISPID_SGRSRule',
    'DISPIDSPTSI_ActiveOffset', 'SPDKL_DefaultLocation',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SADefaultFormat',
    'DISPID_SFSClose', 'SPSModifier', 'SSSPTRelativeToEnd',
    'ISpeechRecoGrammar', 'eLEXTYPE_PRIVATE4',
    'SGDSActiveWithAutoPause', 'SPSMF_SAPI_PROPERTIES',
    ...
    'SPEVENTENUM', 'SpeechLexiconType', 'SRADynamic',
    'SVSFUnusedFlags', 'SAFT8kHz8BitMono', 'SVP_10',
    'DISPID_SRRTLength', 'DISPID_SVSRunningState', 'SLOStatic',
    'SP_VISEME_5', 'SpObjectToken', 'DISPID_SRCEBookmark',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpeechFileStream',
    'SRESoundStart', 'DISPID_SAFGuid', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRCSetAdaptationData', 'DISPID_SPEAudioSizeBytes',
    'SVP_17', 'DISPID_SRGCommit', 'DISPID_SGRSTPropertyId',
    'DISPID_SABufferNotifySize', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPRuleChildren', 'SPFM_CREATE', 'ISpeechRecoContext',
    ...
    'eLEXTYPE_PRIVATE5', 'SDTAudio', 'SPAO_RETAIN_AUDIO',
    'SPBO_PAUSE', 'DISPID_SLPType', 'DISPID_SVIsUISupported',
    'DISPID_SVSPhonemeId', 'SPINTERFERENCE_TOOQUIET', 'SVEPrivate',
    'SpTextSelectionInformation', 'ISpNotifyTranslator',
    'Speech_Max_Word_Length', 'DISPID_SGRsCommitAndSave',
    'SP_VISEME_14', 'DISPID_SGRs_NewEnum', 'SP_VISEME_12',
    'DISPID_SMSAMMHandle', 'SAFT32kHz16BitMono', 'DISPID_SOTDataKey',
    'SGDSActiveUserDelimited', 'SPRS_INACTIVE',
    'DISPID_SpeechPhraseProperty', 'SPAUDIOSTATE',
    'DISPID_SRGCmdLoadFromMemory', 'ISpPhraseAlt', 'DISPID_SRCResume',
